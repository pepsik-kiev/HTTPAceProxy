...
logomap = {
    ...
    u'2x2 (+7)': logobase + 'j2SgcFqmfboqAR9okiC3EANoceIPHM.png',
    ...
    u'7ТВ': logobase + 'FVuz7bGWoqbPG6F1UBUFCFbOvTYsVg.png',
    ...
    u'A1 Одесса': logobase + '6nS5YVxNbrBkKm9FeyIApOeq0RWqTz.png',
    ...
    u'ARM Film HD': logobase + 'mNjq6zkpWC5DVaRLKqlS7S2yPIXSgR.png',
    ...
    u'ATV': logobase + 'MpiYYm4N49ibw50qvCNHpRqJfBql7S.png',
    u'ATV (Венгрия)': logobase + 'g2v1gLo1qLj9Zp8Gcuy2XqML3ieNvd.png',
    u'ATV Azerbaycan': logobase + 'yx7GzFSH3BlxYYa0Nuq4eiVRqxZSa5.png',
    u'ATV Filmzone': logobase + 'jAYhiukQ1wyqaN4Bs1cEd8dybN89Mf.png',
    u'ATV Kinoman': logobase + 'yAUEZPoZhY29PgELhxvfPAMfch5gZa.png',
    ...
    u'Beatz': logobase + 'yZeQdeMCKLT9DlpiNbSIs5pRhnKUl3.png',
    ...
    u'Chelsea TV': logobase + 'VB93XpRDioVQfLgNLYB4dEpjxcbn22.png',
    u'Cinema': logobase + 'wpspDreDq2gIcKq4flMLwItJsG7yyx.png',
    u'City Radio TV': logobase + 'NkKEqUjoezuRl2JXfYvMB2kwGKfMMY.png',
    ...
    u'Comedy TV Georgia': logobase + 'bzj67xt79bORTSsnTGbOQt4cbnCkrP.png',
    ...
    u'Discover Georgia HD': logobase + 'QgLPXtGI2AnrtibZpdFSETjCcm9oE6.png',
    ...
    u'Discovery Science HD': logobase + 's4cRpsBYcmr8qLcAL2V6kSVBErCE40.png',
    u'Discovery Showcasе HD': logobase + 'SjkR8V88mcLlQNmJloJveP9nrLM1G1.png',
    ...
    u'EROX (HD)': logobase + 'Urx6R817gR9hpTq7hkNefThhKE2j57.png',
    ...
    u'Eska Rock TV': logobase + 'u60nMxgPAShFa0W26Wt6gzG8YEFfjn.png',
    ...
    u'EU Music HD': logobase + 'aSe2xz8tcXCAiDpPkRuJnMJejXfaCB.png',
    ...
    u'Eurosport 2 Gold': logobase + 'U6skSv3sytsz2yt6hLjmGWYHi4tGYB.png',
    u'Eurosport 2 HD': logobase + '0mo5WOW3xn7FmcIRM9PMZxb2Zgad86.png',
    u'Eurosport News': logobase + 'WGnNey94aldJetdQhFqU3CUuLBZBVA.png',
    ...
    u'Fjorton HD': logobase + '1wOmmHofjpecFdgDrRKMLFzgQeokv3.png',
    u'Food Network': logobase + 'W68LEGlOOMPtN0qoGXvdkWhHBjKet6.png',
    u'Food Network HD': logobase + 'xnSMs9UjG2FRfU2PPnLyejKSrJc7HJ.png',
    ...
    u'France 4': logobase + 'I1a4cR3qgOyFcn2Bsc5kpKez505hQR.png',
    ...
    u'Gametoon (HD)': logobase + 'G270kQh7WaG6GanP4onJcxJU76ocwK.png',
    ...
    u'Investigation Discovery Europe HD': logobase + 'EHXYsaPm4I0gxE8wLLPvEkidGNRV5P.png',
    ...
    u'Jukebox': logobase + 'Ep6ao6zqRMnTFUOv67MkWbdPiDeR3U.png',
    ...
    u'Kanаl 2 (1)': logobase + 'rEuErsoVICOvz7v8NqQU1XM0S1K9Qw.png',
    ...
    u'KissFm': logobase + 'nDEgAziUge7C46wYqql9xe3vtT2W86.png',
    ...
    u'London Live HD': logobase + '7ygzZVrnYZkAQD41U2MwCL1tOwIgkU.png',
    ...
    u'LRT TELEVIZIJA': logobase + '2FbMaXc9NFOacUxEJc36LbzzfYE4Wp.png',
    ...
    u'M2O TV': logobase + 'k6oDxoCFjU89XFKVIqu9nODUfI3GJ8.png',
    ...
    u'MSNBC': logobase + 'oScfUBd9MLyCEEzt7HVEhzTDgL6FEf.png',
    ...
    u'MTV Music 24': logobase + 'f4GhjbuOFDNpceaOFFlxoVPM7zkVOp.png',
    ...
    u'Nautical Channеl HD': logobase + 'LyjNShrX4uBagxP92G7azfOI31Vhom.png',
    ...
    u'NRJ 12': logobase + '7QJkPeh1HI1G7Q2ojE2OlkU11E8qEu.png',
    ...
    u'NUART.TV HD': logobase + 'UWFUFhggqx0LQZgonhxenVaNhzYGW3.png',
    ...
    u'PAC-12 Network HD': logobase + 'MgkS9OLRSMer3HxuA7bLcQHirz73ru.png',
    ...
    u'Private HD': logobase + 'eLI8cEV4PQngjKJ68fK1JlUbZjGLnl.png',
    ...
    u'Radio Italia TV': logobase + '9CIWQ2ewfxCmi4B9aXBqRfeSEOwRB3.png',
    u'Radio Monte-Carlo TV': logobase + 'AiBEgoh3KF7Qh8ePaZ1sErbofvyuNC.png',
    ...
    u'Roma TV HD': logobase + '2J4FySZtl1wIVBccYQpwACS8yRoO9D.png',
    ...
    u'Shant Music HD': logobase + 'PUqLdNY41s37LxqIYEJToDbC59KfGu.png',
    ...
    u'Silk Universal': logobase + 'd4HHzAX4LUIu7oaCAlZqCs1PjaLLr2.png',
    u'Sixx Deutschland': logobase + 'emrddE60uxhIjLTXqefXNX3kPhoPKo.png',
    u'Sjuan': logobase + 'OjB0gFaycsTFNFz0CcavuvCh513Fx4.png',
    u'Sky News International': logobase + 'yFxFEpduSEAxMHhKESfyPjk0TKskTw.png',
    u'Sky Sport Austria': logobase + '7p2edOwbpHCUMexhDOB7Jr39ixbq9o.png',
    ...
    u'Sport 1 HD Lithuania': logobase + 'nkqy49NBvyT8TZxYtOhBGPFURXYxin.png',
    u'Sport Klub Polska HD': logobase + 'ctQJarsbeQz6SDOIJIXkcHUfyx0M4K.png',
    u'Stars TV': logobase + 'fJSB955jGfuiujIhgwidmFjLyTtfro.png',
    u'Stingray iConcerts Europe HD': logobase + '8eYkQeF2HqnId1ffynuUxUzDOISKQE.png',
    ...
    u'Top Sound': logobase + '9Pu3a3zfWtrPzae2Chzc9YiU6gbNXI.png',
    ...
    u'TV1000 Action HD': logobase + 'UoU4W2iHflE3skLa7HOAckAghjsO8i.png',
    u'TV1000 Comedy HD': logobase + 'ygGiR2hkQLySH6khdo8GV9CyMJ8dXi.png',
    u'TV1000 HD': logobase + 'QrhktSr84nmmVwr1lGtLjYrRacFXHl.png',
    u'TV1000 Русское кино HD': logobase + 'pNMutRMPyIVGD7oImz5KQ22nFmKLrk.png',
    u'TV3 (Estonia)': logobase + 'IdcgDRXYPBO8ZguuCAvFnN6z3vCzuX.png',
    u'TV3 Catalunya': logobase + 'JdogLgSiKoXxC7ZlxVLogeOLMQUQyN.png',
    u'TV3 HD Lithuania': logobase + '1Z7ZG4jJw4L5rMLwbI7YaYdt5CUfRD.png',
    ...
    u'Urban Music 4U': logobase + 'MBjvKf3YqwAutK3fBuiL8zEWAi3Qk5.png',
    ...
    u'Viasat Golf HD (ENG)': logobase + 'AsdnWGItRtpLjG62vQgMVAdt8X6DVx.png',
    ...
    u'Vivid TV Europe!': logobase + 'OCCA5zDyVxGFdUzePgVLl9Z1l9eVLB.png',
    ...
    u'WWE Network HD': logobase + 'FbwwkmTjGxVWOe4L0BON4OaIrt1nX9.png',
    ...
    u'XXL': logobase + 'fHweVBRX5pio2aJiRglz4mm1WFU7RM.png',
    ...
    u'АВТО 24 HD (RU)': logobase + 'AhzyVvhTxzlWLsvQxxtRsXHMxkLOpL.png',
    ...
    u'В гостях у сказки': logobase + 'f4UfabNTMHk8daagB4phEjJsiAypYz.png',
    u'В мире животных HD': logobase + 'NefS7NwexRum5zxjT2EFFBgy7pEp7T.png',
    u'ВIНТЕРА': logobase + '2pDVu5ReTtI4GxXgqvr6qiaVGZQyhj.png',
    ...
    u'Дождь HD': logobase + '4XP4j8QtUohjoSWSouM6Flc6bs4A6f.png',
    ...
    u'Домашний (+4)': logobase + 'MoH282j4BhptYDpX5gJiu4wezEzoNY.png',
    ...
    u'Звезда +7': logobase + 'IcgX2w8OxR0lhoFEbmeMFDBiQdcswH.png',
    ...
    u'Липецкое Время': logobase + 'zalntdtrQ9A1Zr0PO3oSSigCp4bedk.png',
    ...
    u'Новороссия тв': logobase + 'dugC6c8IB6PiElvjDcm7QVN122g5G1.png',
    ...
    u'НТВ (+4)': logobase + 'kCRrWw0ZvYsGC50dcHOoMEtkdCoxY9.png',
    ...
    u'НТВ Хит': logobase + 'Y8Z5m7wX4c2mNYN7qJVUllrebi8Z58.png',
    ...
    u'Первый Республиканский': logobase + 'xHinzy6VVByQrVALxgvpT8UOijr2lp.png',
    ...
    u'Пятница (+4)': logobase + 'X6teOFnHTNwFrwdxDUyiAX64n9mpyP.png',
    ...
    u'Пятый канал (+4)': logobase + '89yiC3MpsVvD6994YMggRKCLro1myB.png',
    ...
    u'РЕН ТВ (+4)': logobase + '8nPpmlnRXKFzd57UkaTvPvARXLwX9m.png',
    ...
    u'Рустави 2': logobase + 'JOiF9C8Szpz9YMsjC93YYjXDod7MyF.png',
    ...
    u'ТВ 3 (+4)': logobase + 'lAn7SbQWQ5PoDUCrf3rjrOB4lTq6CB.png',
    u'ТВ 3 HD': logobase + 'Kto89eK6OdrV2G5WKhh42tqt9HWWdv.png',
    u'ТВ FM': logobase + 'A3YxOjZfAw2KJ3naZrCznXfdlotAlw.png',
    u'ТВ Центр (+4)': logobase + 'pRvKXnyGccYw2LavsVk4azEfPBwzWY.png',
    ...
    u'Ювелирочка Мода': logobase + 'AS4bHK4T7g6UKlN7B2kb2xDR9BctDs.png',
    u'Югра ТВ': logobase + 'lV4x8t8AW4Q4UeOBAjwuzBzR0GdnxJ.png',
    u'Юмор ТВ': logobase + '6VFA1SVxeFHUsGaKPbNxWZREDkGeZw.png',
    u'Юрган': logobase + 'qnZeCbC5B7c9rfyFygcHbBRb5RMvbr.png',
