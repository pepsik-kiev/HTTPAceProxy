...
The colored output is generated only when the console is a terminal supporting it,
so if you redirect the output to a log file you will not see the escape codes in the file.
    ...
    def add_coloring_to_emit_ansi(fn):
        ...
        def new(*args):
            ...
            if levelno >= 50:
                ...
                color = '\x1b[91m'  # ERROR light red
            elif levelno >= 30:
                color = '\x1b[93m'  # WARNING light yellow
            elif levelno >= 20:
                ...
                color = '\x1b[0m'   # normal
            try:
                new_args[1].msg = color + six.text_type(new_args[1].msg) + '\x1b[0m'  # normal
